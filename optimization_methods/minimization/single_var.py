...
class Minimizer:
    ...
    def __init__(self, func, eps, start_point=None, 
                 der_func=None, step=None, start_segment=None, output=False):
        self.func = func
        ...
        if not start_segment:
            ...
            self.start_local_segment = start_segment
    ...
    def dichotomy(self, sigma):
        ...
        y = []
        z = []
        while abs(segment[k][0] - segment[k][1]) > self.eps and k < 5:
            print(segment[k])
